  ...
  return (
    ...
    >
      ...
      <Modal visible={openModal} transparent animationType="slide">
        <TouchableOpacity
          style={GlobalStyles.modal_content}
          onPress={() => setOpenModal(false)}
        >
          <TouchableOpacity
            style={[GlobalStyles.modal_card, { backgroundColor: colors.card }]}
            activeOpacity={1}
          >
            <Text style={[GlobalStyles.modal_title, { color: colors.text }]}>
              Add Contact
            </Text>
            <TextInput
              style={[
            ...
            >
              <Text
                style={[GlobalStyles.modal_button_text, { color: colors.text }]}
              >
                Add Contact
              </Text>
            </TouchableOpacity>
            <Text
              style={GlobalStyles.modal_cancel}
              onPress={() => setOpenModal(false)}
            >
              Cancel
            </Text>
      ...
      <Modal visible={showMenuModal} transparent animationType="fade">
        ...
        >
          <TouchableOpacity
            style={[GlobalStyles.menu_card, { backgroundColor: colors.card }]}
            activeOpacity={1}
          >
            <Text
              style={[GlobalStyles.menu_contact_name, { color: colors.text }]}
            >
              {menuContact?.name}
            </Text>
            ...
            >
              <Text
                style={[GlobalStyles.menu_option_text, { color: colors.text }]}
              >
                ✏️ Edit
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                style={[
                  GlobalStyles.menu_option_text,
                  GlobalStyles.menu_delete_text,
                ]}
              >
                🗑️ Remove
              </Text>
      ...
      <Modal visible={showGroupPickerModal} transparent animationType="slide">
        ...
        >
          ...
          >
            ...
            <Text
              style={[GlobalStyles.group_picker_label, { color: colors.text }]}
            >
              Create new group
            </Text>
            <TextInput
            ...
            {groups.length > 0 && (
              <>
                <Text
                  style={[
                    GlobalStyles.group_picker_label,
                ...
                {groups.map((g) => (
                  ...
                  >
                    <Text
                      style={[
                        GlobalStyles.group_picker_row_text,
                        { color: colors.text },
                      ]}
                    >
                      {g.name}
                    ...
                    <Text
                      style={[
                        GlobalStyles.group_picker_count,
      ...
      <Modal visible={showGroupMenuModal} transparent animationType="fade">
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              style={GlobalStyles.menu_option}
              onPress={() => menuGroup && openEditGroupModal(menuGroup)}
            >
              <Text
                style={[GlobalStyles.menu_option_text, { color: colors.text }]}
              >
            ...
            {editingGroup?.memberIds.map((memberId) => {
              ...
              return (
                <TouchableOpacity
                  key={memberId}
                  style={[
                    GlobalStyles.remove_member_row,
                    {
                      backgroundColor: colors.background,
                      borderColor: colors.border,
                      borderWidth: 1,
                ...
                >
                  <Text
                    style={[
                      GlobalStyles.remove_member_name,
                      { color: colors.text },
                    ]}
                  >
                    {contact.name}
      ...
      <Modal visible={showCreateGroupModal} transparent animationType="slide">
        ...
        >
          ...
          >
            ...
            <ScrollView
              style={GlobalStyles.create_group_member_list}
              nestedScrollEnabled
            >
              {contacts.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text
                      style={[
                        GlobalStyles.create_group_checkbox,
                        { color: colors.text },
                      ]}
                    >
                      {selected ? "☑" : "☐"}
            ...
            <TouchableOpacity
              style={[
                GlobalStyles.modal_button,
                {
                  ...
                  marginTop: 12,
                  opacity:
                    createGroupName.trim() && selectedContactIds.length > 0
                      ? 1
                      : 0.5,
                },
              ]}
      ...
      <View style={[GlobalStyles.tab_switcher, { borderColor: colors.border }]}>
        <TouchableOpacity
          style={[
            GlobalStyles.tab_btn,
            { backgroundColor: colors.background },
            activeTab === "contacts" && { backgroundColor: colors.tabActive },
          ]}
          onPress={() => {
        ...
        >
          <Text style={[GlobalStyles.tab_btn_text, { color: colors.text }]}>
            Contacts
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            GlobalStyles.tab_btn,
            { backgroundColor: colors.background },
            activeTab === "groups" && { backgroundColor: colors.tabActive },
          ]}
          onPress={() => {
            setActiveTab("groups");
            setSearchText("");
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <View>
                  <Text
                    style={[GlobalStyles.contact_name, { color: colors.text }]}
                  >
                    {item.name}
                  </Text>
                  <Text
                    style={[
                      GlobalStyles.contact_name,
                      { color: colors.text, opacity: 0.6 },
                    ]}
                  >
                    {item.phone}
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  >
                    <Text
                      style={[GlobalStyles.menu_icon, { color: colors.text }]}
                    >
                      💬
                    </Text>
                  </TouchableOpacity>
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <View style={{ flex: 1 }}>
                      <TouchableOpacity
                        onPress={() => toggleGroupExpand(item.id)}
                      >
                        <Text
                          style={[
                            GlobalStyles.contact_name,
                        ...
                        <Text
                          style={[
                            GlobalStyles.group_member_count,
                            { color: colors.text, opacity: 0.6 },
                          ]}
                        >
      ...
      <View style={GlobalStyles.buttons}>
        {activeTab === "contacts" && (
          <View
            style={[
              GlobalStyles.addContact_button_body,
              {
                backgroundColor: colors.background,
                borderColor: colors.border,
              },
          ...
          >
            <TouchableOpacity onPress={() => setOpenModal(true)}>
              <Text
                style={[GlobalStyles.addContact_button, { color: colors.text }]}
              >
                ➕ Add Contact
              </Text>
            </TouchableOpacity>
